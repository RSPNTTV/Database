    ...
    pcall(function()
        ...
        task.spawn(function()
            ...
            if (uniform.Helmet:FindFirstChild("RightLogo")) then
                uniform.Helmet.RightLogo.Decal.Texture = getcustomasset(AssetsFolder .. teamInfo.City .. "/0001.png", false)
                uniform.Helmet.LeftLogo.Decal.Texture = getcustomasset(AssetsFolder .. teamInfo.City .. "/0001.png", false)
            end
